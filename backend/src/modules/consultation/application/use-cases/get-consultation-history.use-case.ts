  ...
  public async execute(
    ...
    try {
      ...
      const result = dto.isTrainer
        ? await this.consultationRepo.findHistoryByTrainerId(dto.userId, options)
        : await this.consultationRepo.findHistoryByClientId(dto.userId, options);
      ...
      const message =
        error instanceof Error
          ? error.message
          : 'An unexpected error occurred while listing consultation history';
