...
import { AcceptTrainerRequestCommandDTO } from '../../dto/accept-trainer-request.dto';
...
export class AcceptTrainerRequestUseCase {
  ...
  public async execute(
    dto: AcceptTrainerRequestCommandDTO,
    ...
    try {
      ...
      // Execute Aggregate Root state transition method (throws Domain Exception on invalid transition)
      pipeline.accept();
      ...
      const message =
        error instanceof Error
          ? error.message
          : 'An unexpected error occurred while accepting trainer request';
