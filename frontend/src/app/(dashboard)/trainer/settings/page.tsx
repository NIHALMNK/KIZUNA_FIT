...
export default function TrainerSettingsPage() {
  ...
  const safeAccount = account || {
    ...
    phoneNumber: null,
    role: (user?.role || 'TRAINER') as 'CLIENT' | 'TRAINER' | 'ADMIN',
    emailVerified: true,
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs sm:text-sm text-[var(--color-text-secondary)] font-normal">
          Manage your account identity, security preferences, connected accounts, and active
          sessions.
        </p>
      </div>
      ...
      <SecurityCard changePasswordHref="/trainer/settings/change-password" />
