...
export const TrainerDashboardHeader: React.FC<TrainerDashboardHeaderProps> = ({
  ...
  if (!computedTitle || !computedBreadcrumb) {
    if (pathname === '/profile/trainer') {
      computedTitle = 'Profile';
      computedBreadcrumb = ['Dashboard', 'Profile'];
    } else if (pathname === '/profile/trainer/create') {
      computedTitle = 'Create Profile';
      computedBreadcrumb = ['Dashboard', 'Profile', 'Create'];
    } else if (pathname === '/profile/trainer/edit') {
      computedTitle = 'Edit Profile';
      computedBreadcrumb = ['Dashboard', 'Profile', 'Edit'];
    } else if (pathname === '/profile/trainer/availability') {
      computedTitle = 'Availability';
      computedBreadcrumb = ['Dashboard', 'Availability'];
    } else if (pathname === '/profile/trainer/certifications') {
      computedTitle = 'Certifications';
      computedBreadcrumb = ['Dashboard', 'Certifications'];
